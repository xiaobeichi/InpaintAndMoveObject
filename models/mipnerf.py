...
from utils.ray_utils import sample_along_rays, resample_along_rays, volumetric_rendering, namedtuple_map
from utils.pose_utils import to8b
...
class MipNeRF(nn.Module):
    def __init__(self,
        ...
        self.u = torch.nn.Parameter(torch.ones(n_images))
